...
export function BookForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`http://localhost:8081/libro/save-book?utenteId=${window.localStorage.getItem("userId")}`, {
        method: 'POST',
        headers: {
  ...
  <div>
    ...
    <Form onSubmit={handleSubmit}>
      ...
      {/* Add similar Form.Control components for other fields in your LibroRequest object */}
